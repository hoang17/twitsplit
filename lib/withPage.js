...
import * as evenActions from '../actions/events'
import * as questionActions from '../actions/questions'
const { setPath, setUser, setUserIP } = appActions
...
function withPage(Page){
  ...
  class Index extends React.Component {
    ...
    componentDidMount () {
      this.unsub = auth(user => this.props.setUser(user))
    }
    ...
    render() {
      const { classes, theme, app, closeSnack } = this.props
      const { user, snack } = app
      ...
      return (
        <div className={classes.root}>
          ...
          <div className={classes.appFrame}>
            ...
            <Snackbar open={snack.open} msg={snack.msg} onClose={closeSnack} />
          </div>
        </div>
      )
    }
